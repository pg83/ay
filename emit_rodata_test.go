...
func TestEmitRD_NodeShape(t *testing.T) {
	...
	_, asmOut, objOut := nodeTestEmitContext(e, instance).emitRD("icudt78_dat.rodata", source("contrib/libs/icu/icudt78_dat.rodata"), NodeRef(7), Closure{}, nil, testToolchain())
