...
var (
	ccIncludesPrefix = []string{
		"-I$(B)",
		"-I$(S)",
	}
	ccIncludesSuffix = []string{
	...
	noLibcWarningSuppressions = []string{
		"-Wno-array-parameter",
	...
	catboostOpenSourceDefine = []string{
		"-DCATBOOST_OPENSOURCE=yes",
	}
	builtinMacroDateTime = []string{
		"-Wno-builtin-macro-redefined",
		`-D__DATE__="Jan 10 2019"`,
		`-D__TIME__="00:00:00"`,
	}
	macroPrefixMapFlags = []string{
		"-fmacro-prefix-map=$(B)/=",
		"-fmacro-prefix-map=$(S)/=",
		"-fmacro-prefix-map=$(TOOL_ROOT)/=",
	}
	noWarningsBundle = []string{
		"-Wno-everything",
	}
	cxxStandardWarnings = []string{
