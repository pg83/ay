...
func TestParsedIncludes_BoostMPLIncludePreprocessedExpandsSubtree(t *testing.T) {
	root := t.TempDir()
	writeFiles(t, root, map[string]string{
		"contrib/restricted/boost/mpl/include/boost/mpl/aux_/include_preprocessed.hpp":           "// dispatcher\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/aux_/preprocessed/gcc/advance.hpp":       "#pragma once\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/aux_/preprocessed/plain/list.hpp":        "#pragma once\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/list/aux_/include_preprocessed.hpp":      "// dispatcher\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/list/aux_/preprocessed/plain/list10.hpp": "#pragma once\n",
	})

	scanner := NewIncludeScanner(root, SysInclSet{})
	got := scanner.parsedIncludes(Source("contrib/restricted/boost/mpl/include/boost/mpl/aux_/include_preprocessed.hpp")).bucket(parsedIncludesLocal)
	assertHasIncludeDirective(t, got, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/mpl/include/boost/mpl/aux_/preprocessed/gcc/advance.hpp"})

	listGot := scanner.parsedIncludes(Source("contrib/restricted/boost/mpl/include/boost/mpl/list/aux_/include_preprocessed.hpp")).bucket(parsedIncludesLocal)
	assertHasIncludeDirective(t, listGot, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/mpl/include/boost/mpl/list/aux_/preprocessed/plain/list10.hpp"})
}

func TestParsedIncludes_BoostAtomicMacroIncludeExpandsMatchingHeaders(t *testing.T) {
	root := t.TempDir()
	writeFiles(t, root, map[string]string{
		"contrib/restricted/boost/atomic/include/boost/atomic/detail/capabilities.hpp": `#include BOOST_ATOMIC_DETAIL_CORE_BACKEND_HEADER(boost/atomic/detail/caps_)
#include BOOST_ATOMIC_DETAIL_CORE_ARCH_BACKEND_HEADER(boost/atomic/detail/caps_arch_)
`,
		"contrib/restricted/boost/atomic/include/boost/atomic/detail/caps_gcc_atomic.hpp":   "#pragma once\n",
		"contrib/restricted/boost/atomic/include/boost/atomic/detail/caps_windows.hpp":      "#pragma once\n",
		"contrib/restricted/boost/atomic/include/boost/atomic/detail/caps_arch_gcc_x86.hpp": "#pragma once\n",
	})

	scanner := NewIncludeScanner(root, SysInclSet{})
	got := scanner.parsedIncludes(Source("contrib/restricted/boost/atomic/include/boost/atomic/detail/capabilities.hpp")).bucket(parsedIncludesLocal)
	assertHasIncludeDirective(t, got, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/atomic/include/boost/atomic/detail/caps_gcc_atomic.hpp"})
	assertHasIncludeDirective(t, got, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/atomic/include/boost/atomic/detail/caps_windows.hpp"})
	assertHasIncludeDirective(t, got, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/atomic/include/boost/atomic/detail/caps_arch_gcc_x86.hpp"})
}

func TestParsedIncludes_BoostConfigMacroIncludeExpandsABIAndPlatformTargets(t *testing.T) {
	root := t.TempDir()
	writeFiles(t, root, map[string]string{
		"contrib/restricted/boost/config/include/boost/config.hpp":                    "#include BOOST_PLATFORM_CONFIG\n",
		"contrib/restricted/boost/config/include/boost/config/platform/cloudabi.hpp":  "#pragma once\n",
		"contrib/restricted/boost/config/include/boost/config/platform/haiku.hpp":     "#pragma once\n",
		"contrib/restricted/boost/context/include/boost/context/detail/apply.hpp":     "#include BOOST_ABI_PREFIX\n#include BOOST_ABI_SUFFIX\n",
		"contrib/restricted/boost/config/include/boost/config/abi/msvc_prefix.hpp":    "#pragma once\n",
		"contrib/restricted/boost/config/include/boost/config/abi/msvc_suffix.hpp":    "#pragma once\n",
		"contrib/restricted/boost/config/include/boost/config/abi/borland_prefix.hpp": "#pragma once\n",
		"contrib/restricted/boost/config/include/boost/config/abi/borland_suffix.hpp": "#pragma once\n",
	})

	scanner := NewIncludeScanner(root, SysInclSet{})
	platformGot := scanner.parsedIncludes(Source("contrib/restricted/boost/config/include/boost/config.hpp")).bucket(parsedIncludesLocal)
	assertHasIncludeDirective(t, platformGot, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/config/include/boost/config/platform/cloudabi.hpp"})
	assertHasIncludeDirective(t, platformGot, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/config/include/boost/config/platform/haiku.hpp"})

	abiGot := scanner.parsedIncludes(Source("contrib/restricted/boost/context/include/boost/context/detail/apply.hpp")).bucket(parsedIncludesLocal)
	assertHasIncludeDirective(t, abiGot, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/config/include/boost/config/abi/msvc_prefix.hpp"})
	assertHasIncludeDirective(t, abiGot, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/config/include/boost/config/abi/msvc_suffix.hpp"})
}

func TestParsedIncludes_BoostPPIterateExpandsIterationAndSlotHeaders(t *testing.T) {
	root := t.TempDir()
	writeFiles(t, root, map[string]string{
		"contrib/restricted/boost/type_traits/include/boost/type_traits/detail/is_function_ptr_helper.hpp":    "#include BOOST_PP_ITERATE()\n#include BOOST_PP_ASSIGN_SLOT(1)\n",
		"contrib/restricted/boost/preprocessor/include/boost/preprocessor/iteration/detail/iter/forward1.hpp": "#pragma once\n",
		"contrib/restricted/boost/preprocessor/include/boost/preprocessor/slot/detail/shared.hpp":             "#pragma once\n",
	})

	scanner := NewIncludeScanner(root, SysInclSet{})
	got := scanner.parsedIncludes(Source("contrib/restricted/boost/type_traits/include/boost/type_traits/detail/is_function_ptr_helper.hpp")).bucket(parsedIncludesLocal)
	assertHasIncludeDirective(t, got, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/preprocessor/include/boost/preprocessor/iteration/detail/iter/forward1.hpp"})
	assertHasIncludeDirective(t, got, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/preprocessor/include/boost/preprocessor/slot/detail/shared.hpp"})
	assertLacksIncludeDirective(t, got, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/mpl/include/boost/mpl/apply.hpp"})
}

func TestScanner_BoostSerializationConsumerPullsBoostMPLMacroExpansion(t *testing.T) {
	root := t.TempDir()
	writeFiles(t, root, map[string]string{
		"src.cpp": "#include <boost/serialization/shared_ptr_132.hpp>\n",
		"contrib/restricted/boost/serialization/include/boost/serialization/shared_ptr_132.hpp": "#include <boost/mpl/apply_wrap.hpp>\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/apply_wrap.hpp":                         "#include BOOST_PP_ITERATE()\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/apply.hpp":                              "#include <boost/mpl/aux_/include_preprocessed.hpp>\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/apply_fwd.hpp":                          "#pragma once\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/arg.hpp":                                "#pragma once\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/list/aux_/numbered.hpp":                 "#include <boost/preprocessor/repetition/enum.hpp>\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/aux_/include_preprocessed.hpp":          "// dispatcher\n",
		"contrib/restricted/boost/mpl/include/boost/mpl/aux_/preprocessed/gcc/apply.hpp":        "#pragma once\n",
		"contrib/restricted/boost/preprocessor/include/boost/preprocessor/repetition/enum.hpp":  "#pragma once\n",
	})

	scanner := NewIncludeScanner(root, SysInclSet{})
	parsed := scanner.parsedIncludes(Source("contrib/restricted/boost/mpl/include/boost/mpl/apply_wrap.hpp")).bucket(parsedIncludesLocal)
	assertHasIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/mpl/include/boost/mpl/apply.hpp"})
	assertHasIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/mpl/include/boost/mpl/apply_fwd.hpp"})
	assertHasIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/mpl/include/boost/mpl/arg.hpp"})
	assertHasIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/mpl/include/boost/mpl/list/aux_/numbered.hpp"})
	...
	assertHasVFS(t, closure, Source("contrib/restricted/boost/serialization/include/boost/serialization/shared_ptr_132.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/mpl/include/boost/mpl/apply_wrap.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/mpl/include/boost/mpl/apply.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/mpl/include/boost/mpl/aux_/include_preprocessed.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/mpl/include/boost/mpl/aux_/preprocessed/gcc/apply.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/mpl/include/boost/mpl/list/aux_/numbered.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/preprocessor/include/boost/preprocessor/repetition/enum.hpp"))
}

func TestScanner_BoostUtilityResultOfPullsInPlaceFactoryFamily(t *testing.T) {
	root := t.TempDir()
	writeFiles(t, root, map[string]string{
		"src.cpp": "#include <boost/utility/result_of.hpp>\n",
		"contrib/restricted/boost/utility/include/boost/utility/result_of.hpp": `#include <boost/preprocessor/iteration/iterate.hpp>
#include BOOST_PP_ITERATE()
`,
		"contrib/restricted/boost/utility/include/boost/utility/detail/result_of_iterate.hpp": "#pragma once\n",
		"contrib/restricted/boost/utility/include/boost/utility/in_place_factory.hpp": `#include <boost/utility/detail/in_place_factory_prefix.hpp>
#include BOOST_PP_ITERATE()
#include <boost/utility/detail/in_place_factory_suffix.hpp>
`,
		"contrib/restricted/boost/utility/include/boost/utility/typed_in_place_factory.hpp": `#include <boost/utility/detail/in_place_factory_prefix.hpp>
#include BOOST_PP_ITERATE()
#include <boost/utility/detail/in_place_factory_suffix.hpp>
`,
		"contrib/restricted/boost/utility/include/boost/utility/detail/in_place_factory_prefix.hpp": `#include <boost/preprocessor/punctuation/paren.hpp>
#include <boost/preprocessor/repetition/enum.hpp>
`,
		"contrib/restricted/boost/utility/include/boost/utility/detail/in_place_factory_suffix.hpp": "#pragma once\n",
		"contrib/restricted/boost/preprocessor/include/boost/preprocessor/punctuation/paren.hpp":    "#pragma once\n",
		"contrib/restricted/boost/preprocessor/include/boost/preprocessor/repetition/enum.hpp":      "#pragma once\n",
	})

	scanner := NewIncludeScanner(root, SysInclSet{})
	parsed := scanner.parsedIncludes(Source("contrib/restricted/boost/utility/include/boost/utility/result_of.hpp")).bucket(parsedIncludesLocal)
	assertHasIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/utility/include/boost/utility/detail/result_of_iterate.hpp"})
	assertHasIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/utility/include/boost/utility/in_place_factory.hpp"})
	assertHasIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/utility/include/boost/utility/typed_in_place_factory.hpp"})
	...
	assertHasVFS(t, closure, Source("contrib/restricted/boost/utility/include/boost/utility/result_of.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/utility/include/boost/utility/detail/result_of_iterate.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/utility/include/boost/utility/in_place_factory.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/utility/include/boost/utility/typed_in_place_factory.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/utility/include/boost/utility/detail/in_place_factory_prefix.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/utility/include/boost/utility/detail/in_place_factory_suffix.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/preprocessor/include/boost/preprocessor/punctuation/paren.hpp"))
	assertHasVFS(t, closure, Source("contrib/restricted/boost/preprocessor/include/boost/preprocessor/repetition/enum.hpp"))
}

func TestScanner_BoostOptionalFactorySupportDoesNotPullInPlaceFactoryFamily(t *testing.T) {
	root := t.TempDir()
	writeFiles(t, root, map[string]string{
		"src.cpp": "#include <boost/optional/detail/optional_factory_support.hpp>\n",
		"contrib/restricted/boost/optional/include/boost/optional/detail/optional_factory_support.hpp": `namespace boost {
class in_place_factory_base;
class typed_in_place_factory_base;
}
`,
		"contrib/restricted/boost/utility/include/boost/utility/in_place_factory.hpp":            "#pragma once\n",
		"contrib/restricted/boost/utility/include/boost/utility/typed_in_place_factory.hpp":      "#pragma once\n",
		"contrib/restricted/boost/preprocessor/include/boost/preprocessor/punctuation/paren.hpp": "#pragma once\n",
		"contrib/restricted/boost/preprocessor/include/boost/preprocessor/repetition/enum.hpp":   "#pragma once\n",
	})

	scanner := NewIncludeScanner(root, SysInclSet{})
	parsed := scanner.parsedIncludes(Source("contrib/restricted/boost/optional/include/boost/optional/detail/optional_factory_support.hpp")).bucket(parsedIncludesLocal)
	assertLacksIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/utility/include/boost/utility/in_place_factory.hpp"})
	assertLacksIncludeDirective(t, parsed, includeDirective{kind: includeQuoted, target: "contrib/restricted/boost/utility/include/boost/utility/typed_in_place_factory.hpp"})
	...
	assertHasVFS(t, closure, Source("contrib/restricted/boost/optional/include/boost/optional/detail/optional_factory_support.hpp"))
	assertLacksVFS(t, closure, Source("contrib/restricted/boost/utility/include/boost/utility/in_place_factory.hpp"))
	assertLacksVFS(t, closure, Source("contrib/restricted/boost/utility/include/boost/utility/typed_in_place_factory.hpp"))
	assertLacksVFS(t, closure, Source("contrib/restricted/boost/preprocessor/include/boost/preprocessor/punctuation/paren.hpp"))
	assertLacksVFS(t, closure, Source("contrib/restricted/boost/preprocessor/include/boost/preprocessor/repetition/enum.hpp"))
}
