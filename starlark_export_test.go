...
`)
	...
	want := "# Generated by `ay dev make starlark` from ya.make — do not edit.\n\n" +
		...
		"    subscriber = [\n        \"mvel\",\n        \"pg\",\n    ],\n" +
		`    peerdir = ["library/cpp/json/common"],` + "\n" +
		"    srcs = [\n        \"json_value.cpp\",\n        \"json.cpp\",\n    ] + enum_serialization(\"json_value.h\"),\n" +
		")\n"
	if star != want {
...
// TestTranspile_PrettyPreModule: an attribute declared before the module (e.g. a leading
// SUBSCRIBER) still hoists into the single module() call.
func TestTranspile_PrettyPreModule(t *testing.T) {
	star := transpile(t, "SUBSCRIBER(g:ymake)\nPROGRAM(rescompressor)\nPEERDIR(library/cpp/resource)\nSRCS(main.cpp)\nEND()\n")
	...
	want := "# Generated by `ay dev make starlark` from ya.make — do not edit.\n\n" +
		...
		")\n"
	if star != want {
		t.Fatalf("pre-module attribute should hoist into the call:\n--- got ---\n%s\n--- want ---\n%s", star, want)
	}
}
