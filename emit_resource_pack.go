...
func (e *EmitContext) emitRawAuxChunks(entries []PyProtoAuxEntry, hashTag string, resolveDeps bool, closure func(aux VFS, inputs []VFS, ref NodeRef) []VFS) *RawAuxResult {
