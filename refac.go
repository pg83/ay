...
var constFileHeader = map[hoistKind]string{
	...
	hoistAny: "// ANY constants, interned once. Generated by `ay refac consts`.",
...
// `Intern|Source|Build|internStr|internAny|internArg|internEnv("<literal>")` and
...
// names; an internStr key becomes a leading "str" word and a internAny key a
