...
const (
	...
	testClang14Resource       = "CLANG14_RESOURCE_GLOBAL::$(CLANG14)"
	testClang16Resource       = "CLANG16_RESOURCE_GLOBAL::$(CLANG16)"
	testClang18Resource       = "CLANG18_RESOURCE_GLOBAL::$(CLANG18)"
	testClang20Resource       = "CLANG20_RESOURCE_GLOBAL::$(CLANG20)"
	testClangFormatResource   = "CLANG_FORMAT_RESOURCE_GLOBAL::$(CLANG_FORMAT)"
	testClangResource         = "CLANG_RESOURCE_GLOBAL::$(CLANG)"
	testLLDRootResource       = "LLD_ROOT_RESOURCE_GLOBAL::$(LLD_ROOT)"
	testYMakePython3Resource  = "YMAKE_PYTHON3_RESOURCE_GLOBAL::$(YMAKE_PYTHON3)"
