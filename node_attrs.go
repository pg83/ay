...
// Pre-interned "module_tag" values. Every producer assigns one of these
// compile-time constants (the lowercased upstream MODULE_TAG), so the field is
// an STR; the zero STR means absent. Not in str_consts.go since that file is
// generated by `ay refac consts`.
var (
